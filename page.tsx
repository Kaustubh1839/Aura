      ...
      <div className="max-w-md w-full">
        <Card className="w-full shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-lightBlue-600 dark:text-lightBlue-300">AuraMind</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col space-y-3">
              <Link href="/signin" className="w-full">
                <Button className="w-full bg-lightBlue-500 hover:bg-lightBlue-600 dark:bg-lightBlue-600 dark:hover:bg-lightBlue-500">
                  Sign In
                </Button>
              </Link>
              <Link href="/signup" className="w-full">
                <Button
                  variant="outline"
                  className="w-full border-lightBlue-500 text-lightBlue-500 hover:bg-lightBlue-500 dark:border-lightBlue-400 dark:text-lightBlue-400 dark:hover:bg-slate-800"
                >
                  Create Account
                </Button>
              </Link>
